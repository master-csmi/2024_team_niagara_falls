...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item \url{https://en.wikipedia.org/wiki/Waterfall_model}
            
        \item \url{https://www.techtarget.com/searchsoftwarequality/definition/waterfall-model}
            
        \item \url{https://en.ryte.com/wiki/Waterfall_Model}
        
        \item \url{https://www.tutorialspoint.com/sdlc/sdlc_waterfall_model.htm}
